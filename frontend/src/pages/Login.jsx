            ...
            <div className="w-full max-w-md animate-fade-in">
                <div className="glass-card p-8 bg-white/80 dark:bg-black/40 backdrop-blur-2xl">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Log in to book your favorite movies</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <Link to="/register" className="text-rose-600 font-semibold hover:underline">Sign Up</Link>
                    </p>
                </div>
            </div>
        </div>
